...
<body onload="check_form()">
	<div class="container">
		<div class="span-24 last">
			<div class="span-24 last"><jsp:include
					page="/common/header.jsp" /></div>
			

		</div>
		<div class="clear span-5">
			<div class="span-5 last"><jsp:include
					page="/common/adminMenu.jsp" /></div>
		...
		<div class="span-19 last">
			<div class="span-19 last">
				<!--<div id="page-title">-->
				<div
					style="border-bottom: 1px solid #EEEEEE; float: left; width: 100%; height: 40px; margin-bottom: 10px;">
					<h2>
